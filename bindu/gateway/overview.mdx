...
<AccordionGroup>
  ...
  <Accordion title="It doesn't have opinions about your agents" icon="handshake">
    As long as each agent speaks [A2A](https://github.com/GetBindu/Bindu) (a small JSON-RPC 2.0 protocol), the gateway can call it. The Bindu team authored A2A, and `bindufy()`-built agents speak it out of the box.
  </Accordion>
</AccordionGroup>
