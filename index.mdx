  ...
  <div className="relative mx-auto flex max-w-6xl flex-col px-5 sm:px-8 lg:px-10">
    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
       <a
        href="/bindu/introduction/what-is-bindu"
        className="group relative flex flex-col gap-2 overflow-hidden rounded-xl border-2 border-zinc-200 bg-gradient-to-b from-white to-[#f6f7f9] p-5 transition-all duration-300 hover:border-[#8B5CF6]/40 hover:shadow-lg dark:border-zinc-800 dark:bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900 dark:hover:border-[#8B5CF6]/50"
      >
        {/* The Glare Sweep Element */}
        <div className="absolute inset-0 z-0 flex transform justify-center pointer-events-none">
          <div className="h-full w-24 -translate-x-[250%] skew-x-[-25deg] bg-gradient-to-r from-transparent via-[#8B5CF6]/15 to-transparent transition-transform duration-700 ease-out group-hover:translate-x-[250%] dark:via-[#8B5CF6]/20" />
        </div>
        
        {/* Content (Z-10 keeps it above the glare) */}
        <div className="relative z-10">
          <h3 className="text-base font-semibold text-zinc-900 transition-colors dark:text-zinc-100">
            Get Started
          </h3>
