...
<Warning>
Streaming is not yet implemented. `HandleMessagesStream` is defined in the proto but not implemented in `GrpcAgentClient`. See [limitations](/bindu/grpc/limitations) for details.
</Warning>
