...
description: "Three agents, one question — the planner picks the order, extracts the right number at each step, and chains them."
---
...
<Info>
The gateway is already running from the [previous chapter](/bindu/gateway/quickstart); don't restart it.
</Info>
...
<Steps>
  <Step title="Read the planner's system prompt.">
