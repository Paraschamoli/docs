    ...
    <div id="section-1-content" className="relative z-10 max-w-4xl mx-auto w-full will-change-transform origin-center">
      ...
      <div className="mt-12">
        <div>
          <p 
            style={{ fontFamily: "'DM Serif Display', serif" }} 
            className="text-xl sm:text-2xl font-light tracking-wide mb-8 leading-[1.05] dark:text-neutral-200"
          >
  ...
  <div id="section-3-wrapper" className="sticky top-0 h-screen overflow-hidden z-20 flex flex-col items-center justify-center px-6 text-center bg-neutral-50 dark:bg-[#0c0c0c] border-t border-neutral-200 dark:border-white/5 shadow-[0_-20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_-30px_60px_rgba(0,0,0,0.6)]">
    <div id="section-3-content" className="max-w-3xl mx-auto will-change-transform origin-center">
      ...
      <div className="relative inline-flex flex-col items-center justify-center px-4 py-2">
        ...
        <p
          style={{ fontFamily: "'DM Serif Display', serif" }}
          className="relative z-10 text-xl sm:text-2xl font-light tracking-wide text-red-600 dark:text-red-500"
        >
...
export const CodeTabs = ({ tabs, defaultTab }) => {
  ...
  return (
    <div className="w-full overflow-hidden rounded-3xl border border-zinc-200/90 bg-white/90 shadow-[0_10px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl transition-all duration-300 isolate dark:border-white/10 dark:bg-[#0b0b0d] dark:shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
      ...
      <div className="relative bg-[#0A0A0A]">
        ...
        {/* Scrollable Code Container (Scrollbars hidden here!) */}
