...
See commit [77603da](https://github.com/GetBindu/Bindu/blob/main/commit/77603da) and five regression cases in
...
- `gateway/src/session/index.ts:listMessages` paginates at 1000 rows.
  ...
  Tracked in [`known-issues.md`](/roadmap/known-issues/overview) under
